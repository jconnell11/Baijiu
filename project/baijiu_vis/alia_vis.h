...
extern "C" 
{
  ...
  DEXP_V unsigned char *alia_view;             // object image buffer to write
  DEXP_V unsigned char *alia_map;              // map image buffer to write   
  DEXP_V int alia_vfmt, alia_mfmt;             // object and map write formats

  DEXP_V const unsigned char *alia_rng;        // range-finder buffer to read
  DEXP_V const unsigned char *alia_col;        // main color buffer to read
  DEXP_V const unsigned char *alia_aux;        // aux source buffer to read
