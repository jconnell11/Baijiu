// baijiu_test.cpp : keyboard driver for Qtruck used with pc_blulink.py 
//
...
extern "C" DEXP int ext_start (const char *id, int dbg)
{
  return qt.BluStart(id, dbg);
}
